...
class AgreementDataModifyView(BasicFcView):
    ...
    def __init__(self, mainEngine, data, parent=None):
        ...
        self.eventType = EVENT_MODIFY_PD_VIEW
        self.initUi()
    ...
    def showModifyListDetail(self, asset_id, dateToModified):
        """显示所有合约数据"""
        result = self.mainEngine.get_agreement_input_detail_by_id_date_dic(asset_id, dateToModified)
        print(result)
...
class ModifyInput(BasicFcView):
    ...
    def updateData(self):
        ...
        ### 发送修改后的触发信号
        self.mainEngine.eventEngine.put(Event(type_=EVENT_MODIFY_PD_VIEW))
